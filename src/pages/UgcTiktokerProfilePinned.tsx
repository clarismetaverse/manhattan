  ...
  return (
    <div className="max-w-2xl mx-auto p-4 sm:p-6">
      ...
      <div className="rounded-2xl shadow bg-white overflow-hidden">
        ...
        <div className="flex items-center p-4 -mt-10 sm:-mt-12">
          <img src={profile.avatar} alt={profile.name} className="w-20 h-20 sm:w-24 sm:h-24 rounded-full border-4 border-white shadow"/>
      ...
      <div className="mt-6">
        ...
        <div className="flex gap-3 overflow-x-auto pb-2">
          {pinned.map(t => (
            <div key={t.id} className="min-w-[160px] rounded-xl overflow-hidden shadow bg-white cursor-pointer" onClick={() => setOpenPinned(t.id)}>
      ...
      <div className="mt-8 text-center">
        <button className="bg-gradient-to-r from-pink-400 to-fuchsia-500 text-white px-6 py-3 rounded-xl shadow flex items-center justify-center mx-auto">
      ...
      {openPinned && (
        <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-md rounded-2xl shadow p-4 relative">
