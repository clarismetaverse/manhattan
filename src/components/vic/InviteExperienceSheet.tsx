    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          />
          <motion.div
            className="relative z-10 w-full max-w-md overflow-hidden rounded-t-[28px] bg-white shadow-2xl"
            variants={sheet}
                ...
                <div className="space-y-8 px-5 pb-24">
                      ...
                      {upcomingExperiences.map((item) => {
                        ...
                        return (
                          <button
                            ...
                            className={`relative w-[78%] shrink-0 snap-start overflow-hidden rounded-3xl bg-neutral-900 text-left text-white shadow-lg transition active:scale-[0.99] ${
                              isSelected ? "ring-2 ring-[#FF5A7A]/40" : ""
                            }`}
                          >
                            <div className="absolute inset-0 bg-gradient-to-br from-neutral-800 via-neutral-900 to-black" />
                            <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent" />
                            <div className="relative flex h-44 flex-col justify-end p-5">
                              {isSelected && (
                  ...
                  <section className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <button
                        type="button"
                        className="col-span-2 flex items-center justify-between rounded-2xl border border-dashed border-neutral-200 px-4 py-3 text-left text-sm font-medium text-neutral-500"
                      >
                  ...
                  <section className="space-y-4 rounded-3xl border border-neutral-200 bg-neutral-50 p-4">
                    <div>
                    ...
                    <textarea
                      ...
                      className="w-full resize-none rounded-2xl border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-700 shadow-sm focus:border-[#FF5A7A]/60 focus:outline-none"
                    />
                    ...
                    <button
                      type="button"
                      className={`flex w-full items-center justify-center gap-2 rounded-full px-4 py-2 text-sm font-semibold transition ${
                        canSubmitProposal
                    ...
                    <button
                      type="button"
                      className="flex w-full items-center justify-between rounded-2xl border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-600"
                    >
                      <span className="flex items-center gap-2">
                        <Calendar className="h-4 w-4 text-neutral-400" />
                        Select tentative date
                      </span>
