...
export default function InviteExperienceSheet({ open, onClose, creator }: InviteExperienceSheetProps) {
  ...
  const handleSubmitProposal = () => {
    ...
    const budgetNote = budget ? `Budget: ${budget}` : "Budget: flexible";
    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          />
          <motion.div
            className="relative z-10 w-full max-w-md overflow-y-auto rounded-t-[28px] bg-white shadow-2xl scrollbar-hide [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden max-h-[92vh]"
            variants={sheet}
            ...
            <div className="space-y-8 px-5 pb-24">
              ...
              <section className="space-y-4">
                  ...
                  {recommendedExperiences.map((item) => {
                    ...
                    return (
                      <button
                        ...
                        type="button"
                        onClick={() => setSelectedId(item.id)}
                        className={`w-full rounded-2xl border bg-white p-5 text-left shadow-md transition active:scale-[0.99] ${
                          isSelected
                      ...
                      >
                        <div className="flex items-start gap-3">
                          <span className="mt-1 inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-[#FFF1F4] text-[#FF5A7A] shadow-sm">
                ...
                <button
                  ...
                  className="flex w-full items-center justify-between rounded-2xl border border-neutral-200 bg-white px-4 py-3 text-left text-sm font-semibold text-neutral-800 shadow-sm"
                >
              ...
              <section className="space-y-4">
                ...
                <button
                  ...
                  className="flex w-full items-center justify-between rounded-2xl border border-neutral-200 bg-white px-4 py-4 text-left text-sm font-semibold text-neutral-800 shadow-md"
                >
              ...
              {proposalOpen && (
                ...
                >
                  ...
                  >
                    ...
                    <button
                      type="button"
                      className="mt-3 flex w-full items-center justify-between rounded-2xl border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-600"
                    >
                      <span className="flex items-center gap-2">
