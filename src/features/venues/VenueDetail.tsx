      ...
      <div className="mx-auto max-w-sm pb-28">
        ...
        <div className="fixed inset-x-0 bottom-3 px-4">
          <div className="mx-auto max-w-sm rounded-2xl bg-white/70 backdrop-blur-lg ring-1 ring-white/50 p-2">
            ...
            opacity: 1,
            scale: 1,
            boxShadow: "0 0 18px rgba(255,70,100,0.45)"
          } : {
            opacity: 0.6,
            scale: 1
          }} disabled={!enabled} aria-disabled={!enabled} className="w-full rounded-full px-5 py-3 text-white font-medium bg-gradient-to-r from-[#FF5A7A] to-[#FF3A6E] disabled:cursor-not-allowed">
              Select date & time
            </motion.button>
          </div>
        </div>
